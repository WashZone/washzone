...
export const RootStoreBase = withTypedRefs<Refs>()(MSTGQLStore
  ...
  .actions(self => ({
    ...
    mutateCommentOnHomepage(variables: { taginHomeComment: InputhomeCommentTagList[], acttachmentType?: (string | null), acttachmentUrl?: (string | null), comment?: (string | null), homePageId: string, userId: string }, resultSelector: string | ((qb: HomecommentsModelSelector) => HomecommentsModelSelector) = homecommentsModelPrimitives.toString(), optimisticUpdate?: () => void) {
      return self.mutate<{ commentOnHomepage: HomecommentsModelType}>(`mutation commentOnHomepage($taginHomeComment: [InputhomeCommentTagList!]!, $acttachmentType: String, $acttachmentUrl: String, $comment: String, $homePageId: String!, $userId: String!) { commentOnHomepage(taginHomeComment: $taginHomeComment, acttachmentType: $acttachmentType, acttachmentUrl: $acttachmentUrl, comment: $comment, HomePageId: $homePageId, userId: $userId) {
